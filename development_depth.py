...
print("Gradient-boosted regression tree model for predicting uncuffed endotracheal tube depth")
...
# Save the best model
#gs.best_estimator_.get_booster().save_model('gbrt_depth_uncuffed.json')
gbrt_uncuff = gs.best_estimator_.get_booster()
gbrt_uncuff.save_model('gbrt_depth_uncuffed.model')
...
# Get and print the best hyperparameters and score
print("Gradient-boosted regression tree model for predicting cuffed endotracheal tube depth")
print("========= found hyperparameter =========")
print(gs.best_params_)
print(gs.best_score_)
print("========================================")
...
# Save the best model
#gs.best_estimator_.get_booster().save_model('gbrt_depth_cuffed.json')
gbrt_cuff = gs.best_estimator_.get_booster()
gbrt_cuff.save_model('gbrt_depth_cuffed.model')
